...
import { uniswapCheckApproval } from "@/lib/integrations/uniswap/trading"
...
export async function POST(req: Request) {
  ...
  try {
    ...
    console.error("[trading/check-approval]", e)
    ...
    const message = e instanceof Error ? e.message : "Uniswap request failed"
