    ...
    <div className="bg-[#F5F4F0] text-[#111] min-h-screen font-sans antialiased">
      ...
      <section className="relative h-screen overflow-hidden">
        ...
        <div className="absolute inset-x-0 bottom-0 z-30 flex flex-col px-6 md:px-12 pb-12 max-w-3xl">
          ...
          >
            Build &amp;<br />orchestrate<br />autonomous<br />Uniswap agents.
          </h1>
          ...
          <div className="flex gap-8 sm:gap-12">
            {[
              ...
              { value: "180+", label: "Countries (and chains)" },
            ].map((stat, i) => (
              <div
                key={i}
                style={{
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-12 grid-rows-auto gap-3" onMouseMove={handleMouse}>
            ...
            <BentoCard className="col-span-12 md:col-span-4 p-8 min-h-[200px]" delay={120}>
              ...
              <p className="text-sm text-black/45 leading-relaxed">Trace every decision. Watch live price arrows hit your boxes. Debug with full execution history and onchain receipts.</p>
            </BentoCard>
            ...
            <BentoCard className="col-span-12 md:col-span-4 p-8 min-h-[200px]" delay={160}>
              ...
              <p className="text-sm text-black/45 leading-relaxed">Persistent long-term memory across sessions. Agents remember past trades, impermanent loss patterns, and winning liquidity ranges.</p>
            </BentoCard>
            ...
            <BentoCard className="col-span-12 md:col-span-4 p-8 min-h-[200px]" delay={200}>
              ...
              <p className="text-sm text-black/45 leading-relaxed">Define what agents can and cannot do. Fine-grained access control per wallet, pool, and gas limit.</p>
            </BentoCard>
          </div>
        </div>
      </section>
      ...
      <section id="workflow" className="py-32 px-6 md:px-12 lg:px-20 border-t border-black/[0.06] overflow-hidden">
        <div className="max-w-6xl mx-auto">
          <div className="mb-16">
            ...
            <div className="mt-4"><Tag>ARENA</Tag></div>
            <RevealText className="mt-5 text-4xl md:text-5xl font-light tracking-tight leading-[1.05]">
              {"From idea to live Uniswap agent\nin four steps."}
            </RevealText>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-4 gap-3" onMouseMove={handleMouse}>
            {[
              { n: "01", title: "Define",  desc: "Describe your agent in plain language. Set objectives (\"maximize yield on ETH/USDC\"), tools (Uniswap API), and risk boundaries.", delay: 0,   img: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/define-5aafAmGBrxZpOqJ3XLHY3n3qzC2I5K.png" },
              { n: "02", title: "Compose", desc: "Chain agents together in the visual editor. Wire price triggers, liquidity boxes, and coordination logic.", delay: 80,  img: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/compose-5RT5VR4f1Y3GoFmovqTKLTG4UXp3g2.png" },
              { n: "03", title: "Test",    desc: "Run sandboxed simulations on historical + live price data. Inspect every box hit and trade decision.", delay: 140, img: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/test-zm8guZwxJHtwWsJ7XO4B0CF7GzlNK8.png" },
              { n: "04", title: "Deploy",  desc: "Push globally in one click. Agents auto-scale, self-heal, and report PNL back to your dashboard.", delay: 200, img: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/deploy-an8fgHSLzniojkcmRyGGIFQUJF9T5J.png" },
            ].map((step) => (
      ...
      <section id="integrations" className="py-32 px-6 md:px-12 lg:px-20 border-t border-black/[0.06]">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-8 mb-16">
            ...
            <p className="text-sm text-black/45 leading-relaxed max-w-xs">
              200+ native connectors including Uniswap API, v4 hooks, wallets, oracles, and chains. Build custom tools with our SDK in minutes.
            </p>
          </div>
          ...
          <div className="rounded-2xl overflow-hidden border border-black/[0.07] flex flex-col md:block md:relative" onMouseMove={handleMouse}>
            ...
            <div className="flex flex-col gap-3 p-4 md:absolute md:bottom-4 md:right-4 md:p-0 md:w-72">
              ...
              >
                ...
                <p className="text-xs text-black/45 leading-relaxed mb-4">Define any function as a tool your agents can call (TypeScript & Python).</p>
                <div className="bg-black/[0.05] rounded-lg border border-black/[0.07] p-3 font-mono text-[11px] text-black/50 leading-relaxed">
                  <span className="text-black/25">// fetch quote + execute box trigger</span><br />
                  <span className="text-blue-600/70">defineTool</span>{"({"}<br />
                  {"  "}<span className="text-amber-700/70">name</span>: <span className="text-green-700/70">&apos;executeOnBoxHit&apos;</span>,<br />
                  {"  "}<span className="text-amber-700/70">run</span>: <span className="text-black/35">async (params) </span>={">"}<br />
                  {"    "}<span className="text-blue-600/70">uniswap</span>.swapOrAddLiquidity(params)<br />
                  {"})"}
                </div>
              </div>
              ...
              >
                ...
                <p className="text-sm text-black/45">Full REST + WebSocket API. Stream live price hits, swaps, and liquidity actions directly into your product.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="relative py-32 px-6 md:px-12 lg:px-20 border-t border-black/[0.06] overflow-hidden">
        ...
        <div className="relative z-10 max-w-2xl mx-auto text-center">
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-light tracking-tight leading-[1.05] mb-6">
            Start building your<br />Uniswap agent workforce.
          </h2>
      ...
      <footer className="py-10 px-6 md:px-12 lg:px-20 border-t border-black/[0.06]">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
          <span className="font-pixel text-xs tracking-[0.25em] text-black/50">RUMBLE</span>
        ...
        <div className="max-w-6xl mx-auto mt-8 pt-6 border-t border-black/[0.04]">
          <span className="text-xs text-black/20">© 2026 RUMBLE. All rights reserved.</span>
        </div>
      </footer>
    </div>
  )
