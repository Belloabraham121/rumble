/**
 * Canonical chain ids for Rumble ↔ Uniswap / Privy integrations.
...
export const CHAIN_ID_BY_SLUG: Record<RumbleChainSlug, number> = {
  "base-sepolia": 84532,
  "base-mainnet": 8453,
...
export const SLUG_BY_CHAIN_ID: Partial<Record<number, RumbleChainSlug>> = {
  84532: "base-sepolia",
  8453: "base-mainnet",
...
export const DEFAULT_RUMBLE_CHAIN_SLUG: RumbleChainSlug = "base-sepolia"

export function chainIdFromSlug(slug: string): number | undefined {
  return CHAIN_ID_BY_SLUG[slug as RumbleChainSlug]
}

export function slugFromChainId(chainId: number): RumbleChainSlug | undefined {
