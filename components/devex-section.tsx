...
const STEPS = [
  {
    ...
    lang: "bash",
    code: [
      { type: "comment", text: "# Install the Rumble SDK" },
      { type: "command", text: "npm install @rumble/sdk" },
      { type: "gap" },
      { type: "comment", text: "# Initialize your project" },
      { type: "command", text: "npx rumble init" },
      { type: "gap" },
  ...
  },
  {
    ...
    code: [
      ...
      { type: "keyword", text: "import", after: " { Agent, Tool } ", keyword2: "from", string: " '@rumble/sdk'" },
      { type: "gap" },
